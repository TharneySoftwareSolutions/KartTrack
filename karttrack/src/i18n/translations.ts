...
const langs: Record<Lang, Translations> = { it, en,
  es: {
    ...
    developer: 'Desarrollador', license: 'Licencia', deleteRaceTitle: 'Eliminar carrera', deleteRaceMsg: (n) => `¿Eliminar "${n}"?`, weatherLabel: 'Tiempo',
  ...
  fr: {
    ...
    developer: 'Développeur', license: 'Licence', deleteRaceTitle: 'Supprimer course', deleteRaceMsg: (n) => `Supprimer "${n}" ?`, weatherLabel: 'Météo',
  ...
  de: {
    ...
    developer: 'Entwickler', license: 'Lizenz', deleteRaceTitle: 'Rennen löschen', deleteRaceMsg: (n) => `"${n}" löschen?`, weatherLabel: 'Wetter',
  ...
  pt: {
    ...
    developer: 'Desenvolvedor', license: 'Licença', deleteRaceTitle: 'Eliminar corrida', deleteRaceMsg: (n) => `Eliminar "${n}"?`, weatherLabel: 'Tempo',
  ...
  nl: {
    ...
    developer: 'Ontwikkelaar', license: 'Licentie', deleteRaceTitle: 'Race verwijderen', deleteRaceMsg: (n) => `"${n}" verwijderen?`, weatherLabel: 'Weer',
  ...
  pl: {
    ...
    developer: 'Deweloper', license: 'Licencja', deleteRaceTitle: 'Usuń wyścig', deleteRaceMsg: (n) => `Usunąć "${n}"?`, weatherLabel: 'Pogoda',
  ...
  ro: {
    ...
    developer: 'Dezvoltator', license: 'Licență', deleteRaceTitle: 'Șterge cursă', deleteRaceMsg: (n) => `Ștergeți "${n}"?`, weatherLabel: 'Vreme',
  ...
  cs: {
    ...
    developer: 'Vývojář', license: 'Licence', deleteRaceTitle: 'Smazat závod', deleteRaceMsg: (n) => `Smazat "${n}"?`, weatherLabel: 'Počasí',
  ...
  hu: {
    ...
    developer: 'Fejlesztő', license: 'Licenc', deleteRaceTitle: 'Verseny törlése', deleteRaceMsg: (n) => `Törli: "${n}"?`, weatherLabel: 'Időjárás',
  ...
  sv: {
    ...
    developer: 'Utvecklare', license: 'Licens', deleteRaceTitle: 'Ta bort lopp', deleteRaceMsg: (n) => `Ta bort "${n}"?`, weatherLabel: 'Väder',
  ...
  no: {
    ...
    developer: 'Utvikler', license: 'Lisens', deleteRaceTitle: 'Slett løp', deleteRaceMsg: (n) => `Slette "${n}"?`, weatherLabel: 'Vær',
  ...
  da: {
    ...
    developer: 'Udvikler', license: 'Licens', deleteRaceTitle: 'Slet løb', deleteRaceMsg: (n) => `Slette "${n}"?`, weatherLabel: 'Vejr',
    ...
    developer: 'Kehittäjä', license: 'Lisenssi', deleteRaceTitle: 'Poista kilpailu', deleteRaceMsg: (n) => `Poista "${n}"?`, weatherLabel: 'Sää',
  ...
  el: {
    ...
    developer: 'Προγραμματιστής', license: 'Άδεια', deleteRaceTitle: 'Διαγραφή αγώνα', deleteRaceMsg: (n) => `Διαγραφή "${n}";`, weatherLabel: 'Καιρός',
  ...
  sk: {
    ...
    developer: 'Vývojár', license: 'Licencia', deleteRaceTitle: 'Vymazať preteky', deleteRaceMsg: (n) => `Vymazať "${n}"?`, weatherLabel: 'Počasie',
  ...
  hr: {
    ...
    developer: 'Programer', license: 'Licencija', deleteRaceTitle: 'Obriši utrku', deleteRaceMsg: (n) => `Obrisati "${n}"?`, weatherLabel: 'Vrijeme',
  ...
  bg: {
    ...
    developer: 'Разработчик', license: 'Лиценз', deleteRaceTitle: 'Изтриване на състезание', deleteRaceMsg: (n) => `Изтриване на "${n}"?`, weatherLabel: 'Времето',
  ...
  lt: {
    ...
    developer: 'Kūrėjas', license: 'Licencija', deleteRaceTitle: 'Ištrinti lenktynes', deleteRaceMsg: (n) => `Ištrinti "${n}"?`, weatherLabel: 'Orai',
  ...
  lv: {
    ...
    developer: 'Izstrādātājs', license: 'Licence', deleteRaceTitle: 'Dzēst sacīkstes', deleteRaceMsg: (n) => `Dzēst "${n}"?`, weatherLabel: 'Laikapstākļi',
  ...
  et: {
    ...
    developer: 'Arendaja', license: 'Litsents', deleteRaceTitle: 'Kustuta võistlus', deleteRaceMsg: (n) => `Kustutada "${n}"?`, weatherLabel: 'Ilm',
